...
class MapManager():
    ...
    def __init__(self):
        ...
        self.tex1 = loader.loadTexture('tex_bricks.png')
        self.tex2 = loader.loadTexture('tex_metal.png')
        self.tex3 = loader.loadTexture('tex_rocks.png')
        self.tex4 = loader.loadTexture('tex_wood.png')
        self.tex5=loader.loadTexture('tex_a.png')
        self.ctex=self.tex5
        self.tc=1
        #self.skybox=loader.loadModel('skyb.png')
        #self.skybox.setScale(1024)
    ...
    def settex(self):
        self.tchange
        if self.selected_block:
            self.selected_block.texchange(self.ctex)
